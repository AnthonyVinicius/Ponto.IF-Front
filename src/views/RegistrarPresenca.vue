    ...
    <div class="max-w-2xl w-full bg-white rounded-2xl shadow border border-gray-200">
      ...
      <div class="border-t mx-4 mb-5 px-5 py-5 border border-gray-300 rounded-2xl">
        <div class="flex justify-between items-center mb-3">
          ...
          <span class="text-xs text-gray-600 flex items-center gap-1 border border-gray-300 rounded-xl px-3 py-1.5">
        ...
        <div class="border border-gray-300 rounded-2xl flex flex-col items-center justify-center py-6">
          <div class="p-4 m-2 rounded-2xl border border-gray-200">
            <img src="../img/biometria.png" alt="Impressão Digital" class="w-40 h-40 text-gray-400 mb-4">
          </div>
          ...
          <p v-if="mensagem"
            :class="['mt-4 text-sm font-medium', mensagemTipo === 'sucesso' ? 'text-green-600' : 'text-red-600']">
            {{ mensagem }}
          </p>
        </div>
      </div>
